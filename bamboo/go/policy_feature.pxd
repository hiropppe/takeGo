...
cdef bint is_ladder_capture(board.game_state_t *game, int string_id, int pos, int othre_pos,
                            board.game_state_t search_games[80], int depth, int ladder_search_moves[1])

cdef bint is_ladder_escape(board.game_state_t *game, int string_id, int pos, bint is_atari_pos,
                           board.game_state_t search_games[80], int depth, int ladder_search_moves[1])
