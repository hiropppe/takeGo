...
from bamboo.go.board cimport set_board_size, set_komi, allocate_game, initialize_board, put_stone
...
cdef class MCTSServer(object):
    ...
    def save_sgf(self, black_name, white_name):
        ...
        save_gamestate_to_sgf(self.game, '/tmp/', temp_file, black_name, white_name)
