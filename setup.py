...
extensions = [Extension('bamboo.go.board', sources=['bamboo/go/board.pyx'], language="c++", extra_compile_args=["-std=c++11"]),
              ...
              Extension('bamboo.rollout.nakade', sources=["bamboo/rollout/nakade.pyx"], language="c++", extra_compile_args=["-std=c++11"]),
              ...
              Extension('bamboo.rollout.test_nakade', sources=["bamboo/rollout/test_nakade.pyx"], language="c++", extra_compile_args=["-std=c++11"]),
